...
typedef RemixCount (*RemixPFunc) (RemixPCM * src, RemixCount count, void * data);
typedef RemixCount (*RemixPPFunc) (RemixPCM * src, RemixPCM * dest, RemixCount count,
			     void * data);
typedef RemixCount (*RemixPPPFunc) (RemixPCM * src1, RemixPCM * src2, RemixPCM * dest,
...
RemixChunk *
remix_chunk_new_from_buffer (RemixEnv * env, RemixCount start_index, RemixCount length,
			  RemixPCM * buffer)
{
  RemixChunk * u;
...
static RemixCount
_remix_pfunc_apply (RemixEnv * env, RemixPFunc func, RemixChunk * chunk, RemixCount start,
		 RemixCount count, void * data)
{
...
/*
 * _remix_ppfunc_apply (src, src_offset, dest, dest_offset, count, func)
 *
...
/*
 * _remix_pppfunc_apply (src, src_offset, dest, dest_offset, count, func)
 *
 ...
 */
RemixCount
_remix_chunk_clear_region (RemixEnv * env, RemixChunk * chunk, RemixCount start,
			RemixCount length, int channelname, void * unused)
{
...
RemixCount
_remix_chunk_gain (RemixEnv * env, RemixChunk * chunk, RemixCount start, RemixCount count,
...
/*
 * _remix_chunk_copy (src, dest, offset, count, unused)
 *
...
/*
 * _remix_chunk_add_inplace (src, dest, start, count, unused)
 *
 * Add data from 'src' to data in 'dest' from stream index 'start' for
 * 'count' samples. Returns the count of samples actually added.
 */
RemixCount
_remix_chunk_add_inplace (RemixEnv * env, RemixChunk * src, RemixCount src_offset,
		       RemixChunk * dest, RemixCount dest_offset, RemixCount count,
		       int channelname, void * unused)
{
 ...
 */
RemixCount
_remix_chunk_mult_inplace (RemixEnv * env, RemixChunk * src, RemixCount src_offset,
			RemixChunk * dest, RemixCount dest_offset, RemixCount count,
			int channelname, void * unused)
{
 ...
 */
RemixCount
_remix_chunk_fade_inplace (RemixEnv * env, RemixChunk * src, RemixCount src_offset,
			RemixChunk * dest, RemixCount dest_offset, RemixCount count,
			int channelname, void * unused)
{
...
/*
 * _remix_chunk_interleave_2 (env, src1, src1_offset, src2, src2_offset,
 *                         count, dest)
 *
 ...
 */
RemixCount
_remix_chunk_interleave_2 (RemixEnv * env, RemixChunk * src1, RemixCount src1_offset,
			RemixChunk * src2, RemixCount src2_offset, RemixCount count,
...
/*
 * _remix_chunk_deinterleave_2 (env, dest1, dest1_offset, dest2, dest2_offset,
 *                           count, src)
 *
 ...
 */
RemixCount
_remix_chunk_deinterleave_2 (RemixEnv * env, RemixChunk * dest1, RemixCount dest1_offset,
			  RemixChunk * dest2, RemixCount dest2_offset, RemixCount count,
			  int unused, void * src)
{
  return _remix_ppfunc_apply (env, _remix_pcm_deinterleave_2, dest1, dest1_offset,
			   dest2, dest2_offset, count, src);
}

/* PPPFunc appliers */

/*
 * _remix_chunk_blend_inplace (src, src_offset, blend, blend_offset,
 *                          dest, dest_offset, count, unused)
 *
 * Blend data of 'src' into that of 'dest' by blend values given in
 * 'blend'.
 */
RemixCount
_remix_chunk_blend_inplace (RemixEnv * env, RemixChunk * src, RemixCount src_offset,
